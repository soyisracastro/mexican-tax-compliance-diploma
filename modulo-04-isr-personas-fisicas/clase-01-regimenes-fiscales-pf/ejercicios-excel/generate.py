...
# ---------------------------------------------------------------------------
TARIFA_MENSUAL_2026 = [
    # Anexo 8 RMF 2026 (DOF 28-dic-2025) — factor 1.13213 correcto
    ...
    (55640.59, 106410.49, 10434.61, 0.3000),
    (106410.50, 141880.67, 25666.64, 0.3200),
    (141880.68, 425643.66, 37344.33, 0.3400),
    (425643.67, 999999999.99, 133897.59, 0.3500),
]
...
TARIFA_ANUAL_2026 = [
    ...
    (667687.07, 1276925.98, 125215.26, 0.3000),
    (1276925.99, 1702567.97, 307989.62, 0.3200),
    (1702567.98, 5107703.90, 448131.88, 0.3400),
    (5107703.91, 999999999.99, 1606771.10, 0.3500),
]
