"""
Genera los PDFs de entrega para la Clase 02 · Módulo 4.

Produce en la carpeta actual:
    slides-clase-02-modulo-04.pdf     — Slides visuales (sin scripts)
...
def _header_footer(canvas, doc, title):
    ...
    canvas.drawString(doc.leftMargin,
                      doc.bottomMargin - 12,
                      "Diplomado en Herramientas Prácticas ante la Autoridad Fiscal · Módulo 4 · Clase 2")
